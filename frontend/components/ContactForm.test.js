...
test('renders ONE error message if user enters a valid first name and last name but no email.', async () => {
    ...
    const firstNameField = screen.getByLabelText(/first name*/i);
    userEvent.type(firstNameField, "mia");

    const lastNameField = screen.getByLabelText(/last name*/i);
    userEvent.type(lastNameField, "goth");
...
test('renders all firstName, lastName and email text when submitted. Does NOT render message if message is not submitted.', async () => {
    ...
    userEvent.type(firstNameField, "mia");
    userEvent.type(lastNameField, "goth");
    userEvent.type(emailField, "mia@email.com");

    const button = screen.getByRole("button");
    userEvent.click(button);

    //   await waitFor(() => {
    //     const firstNameDisplay = screen.queryByText("mia");
    //     const lastNameDisplay = screen.queryByText("goth");
    //     const emailDisplay= screen.queryByText("mia@email.com");
...
test('renders all fields text when all fields are submitted.', async () => {
    render(<ContactForm/>);
    const firstNameField = screen.getByLabelText(/First Name*/i);
    const lastNameField = screen.getByLabelText(/First Name*/i);
    ...
    //     const emailDisplay = screen.queryByText(/email@email.com/i);
